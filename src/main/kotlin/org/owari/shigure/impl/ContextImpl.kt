...
class ContextImpl() : Context() {
    ...
    override fun get(name: String): Double = vars[name]!!
...
class NoThrowContextImpl() : Context() {
    constructor(initVars: Map<String, Double>, initFns: Map<String, MathFunction>) : this() {
        vars += initVars
        fns += initFns
    }
    ...
    override fun call(funcName: String, vararg args: Double): Double = fns[funcName]?.invoke(args) ?: 0.0
